<?php
    ...
    Class Database{
        ...
        public function Connect(){
            ...
            $this->connection=new mysqli("localhost","root","","musclenfitness");
            // $this->connection=new mysqli("localhost","u311538630_mnfc","rVbd=BNyrn7@","u311538630_musclenfiness");
    ...
    $con = mysqli_connect('localhost', "root","","musclenfitness");
    // $con = mysqli_connect("localhost","u311538630_mnfc","rVbd=BNyrn7@","u311538630_musclenfiness");
