...
<body id="body-pd">
    ...
    <section class="componentContainer">
        ...
        <div class="navigation mb-3">
            <span class="rootMenu"><a href="#">Home</a> / </span><Span class="mainMenu"><a href="#">All Brands</a></Span>
        </div>

        <div class="row">
            <div class="col">
                <h3 style="font-weight: 600;">All Brandss</h3>
            </div>
            <div class="col d-flex flex-row-reverse">
                <a href="brand.php" class="btn btn-primary mr-2 ">Add New</a>
            </div>
                ...
                <div class="col-md-11 col-12 mx-auto">
                    <table class="table" id="myTable">
                       <thead>
                        ...
                        <tbody>
                          <?php
                              include "script/view_brands.php";
                          ?>
